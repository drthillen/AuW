...
public class Out {
  ...
  public static void print(float f, int digits) {
    getOut().printf("%." + digits + "f", f);
  }
  ...
  public static void print(double d, int digits) {
    getOut().printf("%." + digits + "f", d);
  }
  ...
  /**
   * Print the float value f, rounded to `digits` decimal digits, and terminate
   * the line.
   */
  public static void println(float f, int digits) {
    getOut().printf("%." + digits + "f\n", f);
  }
  ...
  /**
   * Print the double value d, rounded to `digits` decimal digits, and terminate
   * the line.
   */
  public static void println(double d, int digits) {
    getOut().printf("%." + digits + "f\n", d);
  }
